...
import CourseFiltersAr from "@/components/course-filters-ar";
...
export default function CoursesPage() {
  ...
  const translations = {
    ar: {
      ...
      introAnswer: "معلومات إضافية عن الدورات",
      loadingFilters: "جارٍ تحميل المرشحات…",
      loadingTable: "جارٍ تحميل الجدول…",
      filtersHeading: "البحث والتصفية",
      filtersDescription: "استخدم المرشحات أدناه للعثور على الدورة المناسبة لك",
      ...
      faqItems: [
        {
          ...
          answer: "تختلف مدة الدورات حسب البرنامج والمستوى",
        },
      ],
    },
    en: {
      ...
      introAnswer: "Additional information about our courses",
      loadingFilters: "Loading filters…",
      loadingTable: "Loading course table…",
      filtersHeading: "Search and Filter",
      filtersDescription:
      ...
      faqItems: [
        {
          ...
          answer: "Course duration varies depending on the program and level",
        },
      ],
    },
  };
    ...
    <Suspense fallback={<Loading />}>
      ...
      >
        ...
        <div className="container relative z-10 px-4 py-12 mx-auto">
          ...
          >
            <CourseFiltersAr onFilterChange={handleFilterChange} />
          </Suspense>
