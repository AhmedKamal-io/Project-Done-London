...
import type {
  AccreditationItem,
} from "@/components/international-accreditations";
...
export default async function HomePage() {
  ...
  // ✅ فرض اللغة الإنجليزية للصفحة الإنجليزية
  const language = "en" as "ar" | "en";
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <InternationalAccreditations
        ...
        language={language} // يمرر 'ar' دائماً
      />
      <CourseGallery moments={momentsJson} />
